...
namespace MailSender.Lib.Data
{
    ...
    {
        public static ObservableCollection<Server> Servers { get; } = new ObservableCollection<Server>
        {
        ...
        public static ObservableCollection<Sender> Senders { get; } = new ObservableCollection<Sender>
        {
        ...
        public static ObservableCollection<Recipient> Recipients { get; } = new ObservableCollection<Recipient>
        {
